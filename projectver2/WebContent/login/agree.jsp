...
<html>
  <head>
    ...
    <style>
      ...
      #sin tr td:nth-child(1) {
        text-align: center;
        background-color: #50403f56;
      }
      #sin ul {
        padding-left: 0px;
      }
  ...
  <body>
   <header id="header">
    ...
    <div id="main">
      <div id="agree">
        <table cellspacing="0">
          <th colspan="1">개인정보수집 안내</th>
          <tr>
            <td id="a"><input type="checkbox" id="agree_1" /> 동의 하기</td>
          </tr>
          <tr>
            <td id="tx">
              <textarea readonly="readonly" text-align="left">
 ...
 ② “몰”은 불특정다수 회원에 대한 통지의 경우 1주일이상 “몰” 게시판에 게시함으로서 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.
          ...
          <tr>
            <td id="a"><input type="checkbox" id="agree_2" /> 동의 하기</td>
          </tr>
          <tr>
            <td id="tx">
              <textarea readonly="readonly" text-align="left">
 ...
 ④ 이용자가 재화 등을 제공받을 때 발송비를 부담한 경우에 “몰”은 청약철회 시 그 비용을  누가 부담하는지를 이용자가 알기 쉽도록 명확하게 표시합니다.</textarea
              >
            </td>
          </tr>
          <tr>
            <td id="a"><input type="checkbox" id="agree_3" /> 동의 하기</td>
          </tr>
          <tr>
            <td id="tx">
